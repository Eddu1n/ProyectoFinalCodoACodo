			...
			<div class="container">
				<section>
					...
					<form method="POST"
						...
						<div class="mb-3">
							<label for="exampleFormControlInput1" class="form-label">Hecho en</label>
							<input name="hecho en"
								value="<%=producto.getHechoEn()%>"  
								type="text" class="form-control" id="exampleFormControlInput1" placeholder="Hecho en" maxlength="50">
						  </div>
